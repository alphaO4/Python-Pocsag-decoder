...
class pocsag_demod(gr.top_block, Qt.QWidget):

    def __init__(self):
        gr.top_block.__init__(self, "Pocsag Demod")
        Qt.QWidget.__init__(self)
        self.setWindowTitle("Pocsag Demod")
...
def main(top_block_cls=pocsag_demod, options=None):
